  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        d="M20.447 20.452h-3.558v-5.569c0-1.328-.026-3.039-1.852-3.039-1.855 0-2.14 1.447-2.14 2.943v5.665H9.34V9.563h3.414v1.489h.049c.476-.9 1.637-1.852 3.368-1.852 3.6 0 4.267 2.367 4.267 5.448v6.804zM5.337 8.076c-1.144 0-2.067-.924-2.067-2.068 0-1.144.923-2.068 2.067-2.068s2.068.924 2.068 2.068c0 1.144-.924 2.068-2.068 2.068zm-1.774 12.376H7.11V9.563H3.563v10.889zM22.225 0H1.771C.792 0 0 .794 0 1.771v20.451C0 23.208.794 24 1.771 24h20.451C23.207 24 24 23.207 24 22.223V1.771C24 .794 23.207 0 22.225 0z"
      />
    </svg>
  );
}
...
export const socialMediaProfiles = [
  { title: 'FaceBook', href: 'https://web.facebook.com/fireflytechsolutions', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/fireflytechsol/', icon: InstagramIcon },
  { title: 'LinkedIn', href: 'https://www.linkedin.com/company/firefly-tech-solutions-pvt-ltd/mycompany/', icon: LinkedInIcon },
