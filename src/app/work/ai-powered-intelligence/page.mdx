...
export const caseStudy = {
  ...
  description:
    'Our platform utilizes sophisticated AI algorithms to analyze legal data, generate documents, and provide insights tailored to individual user requirements.',
