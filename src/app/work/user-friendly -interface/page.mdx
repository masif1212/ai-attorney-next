...
export const caseStudy = {
  ...
  description:
    'With a user-friendly interface and intuitive navigation, AI Attorney is designed to be accessible to individuals and businesses without specialized legal knowledge.',
