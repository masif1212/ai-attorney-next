...
export const caseStudy = {
  ...
  description:
    'Grasp the essence of complex cases effortlessly. Our AI generates clear and concise summaries, highlighting key points, rulings, and implications. Stay informed without getting bogged down in legal jargon.',
