...
export const caseStudy = {
  ...
  title: 'Case Search',
  description:
    'AI Attorney is continuously updated with the latest legal developments, including case law, statutes, and regulatory changes, ensuring that users have access to the most current information.',
